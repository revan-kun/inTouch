...
<body>
	<div class="modal" id="createProject">
		...
		<div class="modal-body">
			...
			<div class="alert alert-success" align="center">Fill up the
				creation form below to proceed</div>

			<form class="form-horizontal" id="createProjectHere" method='post'
				action=''>
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<div class="input-prepend">
								<span class="add-on"><i class="icon-folder-open"></i></span> <input
									type="text" class="input-xlarge" id="projectName"
						...
						<div class="controls">
							<div class="input-prepend">
								<span class="add-on"><i class="icon-briefcase"></i></span> <input
									type="text" class="input-xlarge" id="projectCustomer"
									name="projectCustomer" placeholder="Customer...">
							</div>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<div class="input-append date" id="projectEstimatedCompletion"
								...
								<input class="datepicker span2" id="projectEstimatedCompletion"
									name="projectEstimatedCompletion" size="16" type="text"
									placeholder="yyyy-MM-dd" readonly> <span class="add-on"><i
		...
		<div class="modal-footer">
			<a href="home" class="btn btn-danger"><i
				class="icon-white icon-remove"></i> Close</a>
		</div>
	</div>

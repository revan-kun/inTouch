...
public enum ProjectAttribute {
	ID(1, "id"), NAME(2, "name"), CREATED(3, "created"), ESTIMATED_COMPLETION(4, "estimated_completion"), COMPLETED(5, "completed"), DESCRIPTION(6,
			"description"), CUSTOMER(7, "customer"), STATUS(8, "status");
	private int index;

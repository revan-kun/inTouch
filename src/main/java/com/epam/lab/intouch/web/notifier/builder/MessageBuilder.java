...
public class MessageBuilder {
	...
	public MessageBuilder(Project project) {
	...
	public String builText() {
		...
		messageText.append("There have been changes in ")
				.append(project.getProjectName()).append(" project.\n");
		...
		messageText.append(" For more information visit our website for your reference: ")
				.append(projectURL).append(project.getId());

		return messageText.toString();
	}

	public String buildSubject() {
		messageSubject.append("[inTouch] Changes in ")
				.append(project.getProjectName()).append(" project");
